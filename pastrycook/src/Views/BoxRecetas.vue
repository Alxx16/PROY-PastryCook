                        ...
                        <div>
                            <div class="flex justify-between">
                                <div class="rating flex items-center mt-2.5 mb-5">
                                    ...
                                    <span class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{{ po.ratind }}</span>
                                </div>
                                <div class="flex items-center text-white">
                                    <strong>Dificultad: </strong>   {{ po.nivel }}
                                </div>
                            </div>
