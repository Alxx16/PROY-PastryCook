<template>
    <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <a href="#" class="flex-none rounded-full bg-amber-300 px-3.5 py-1 text-sm font-semibold text-neutral-700 shadow-sm hover:bg-amber-400 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">Registrate! <span aria-hidden="true">&rarr;</span></a>
      </div>
